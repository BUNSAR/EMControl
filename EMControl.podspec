#
#  Be sure to run `pod spec lint EMControl.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://www.bunsar.com/EMControl"
  ...
  s.source       = { :git => "https://github.com/GokhanOrun/EMControl", :tag => "1.0.0" }
  # s.source       = { :git => "http://EXAMPLE/EMControl.git", :tag => "#{s.version}" }
